...
/**************************************************
  ...
  *************************************************
  ...
  $Source: /cvsroot/cpg-contrib/minicms/include/fckeditor_edit.inc.php,v $
  $Revision: 1.13 $
  $Author: donnoman $
...
{
    global $MINICMS,$referer,$lang_minicms, $CONFIG, $THEME_DIR, $ORIGINAL_PHP_SELF;
    ob_start();
...
//echo "<br>$smilies";
    ...
    $cmpath = str_replace('index.php','',$ORIGINAL_PHP_SELF);
